...
export default function CandidateCard({ candidate }: CandidateCardProps) {
  ...
  return (
    <article
      className="cursor-pointer rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm transition hover:border-primary/25 hover:shadow-[0_18px_44px_-30px_rgba(37,99,235,0.5)]"
